...
\def\numel{\ensuremath{{N}}}
\def\numdim{\ensuremath{{D}}}
\def\coefficient{\ensuremath{{k}}}
\def\arr{\ensuremath{{M}}}
\def\src{\ensuremath{{s}}}
\def\mic{\ensuremath{{m}}}
\def\signal{\ensuremath{x}}
\def\IR{\ensuremath{h}}
\def\noise{\ensuremath{n}}
\def\radius{\ensuremath{{\arr}}}
\def\height{\ensuremath{{\arr}}}
...
\def\epochs{\ensuremath{\mathrm{ep}}}
\def\batch{\ensuremath{\mathrm{bs}}}