...
\Author{Saulius Sakavičius$^{1,}$*, Andreas Brendel$^{2}$, Artūras Serackis$^{1}$ and Walter Kellerman$^{2}$}

% Authors, for metadata in PDF
\AuthorNames{Saulius Sakavičius, Andreas Brendel, Artūras Serackis and Walter Kellerman}
...
In this experiment, a several multilayer perceptron architectures were used. The summary of the architectures are presented in \tablename 

% Please add the following required packages to your document preamble:
% \usepackage{multirow}
\begin{table}[]
	\caption{Table of neural network architectures used in for the experimentation}
	\centering
