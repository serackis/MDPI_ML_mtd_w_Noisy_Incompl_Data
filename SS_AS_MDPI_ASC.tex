...
\begin{figure}[h!]
	...
	\caption{The geometry of the acoustic enclosure used for \realworld{} dataset collection and the positions of labeled sound source positions}\label{fig:room_src_pos}
\end{figure}

\subsection{Sound source}
\subsubsection{Source signal}
...
A set of 34 array audio recordings were obtained with the sound source held stationary for \SI{1}{\minute} in one of 34 positions within the enclosure. The coordinates of the sound source were measured using a handheld laser distance measurement tool. The locations of the known source positions are presented in \figurename{} \ref{fig:room_src_pos} as colored circles. The values of the red, green and blue components of each circle color are proportional to the $ x $, $ y $ and $ z $ coordinates of the sound source position.

The vertical coordinate, $ z = \SI{1.9}{\m} $, was constant for all source positions.
